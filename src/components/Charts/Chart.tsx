...
export const Chart = () => {
    ...
    return (
        <div className="w-full">
            <About {...CHART_CONFIG} />
            <div className=" ml-24  mr-4  flex flex-col gap-2 items-center justify-center sm:flex-row sm:mx-36 sm:border sm:items-start sm:gap-6 sm:p-7 sm:rounded-lg sm:justify-between">
                <div className="border w-full px-3 py-5 rounded-lg mb-4   max-w-[500px]">
                    ...
                    <button className="bg-primary rounded-lg py-2 px-4 text-white w-full ">Create Chart</button>
